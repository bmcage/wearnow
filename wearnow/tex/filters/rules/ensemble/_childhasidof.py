...
class ChildHasIdOf(RegExpIdBase):
    """Rule that checks for a person with a specific wearnow ID"""

    labels      = [ _('Garment ID:') ]
    name        = _('Ensembles having garment with Id containing <text>')
    description = _("Matches ensembles where garment has a specified "
                    "WearNow ID")
