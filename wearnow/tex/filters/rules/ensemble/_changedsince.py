...
# gen.filters.rules/ensemble/_ChangedSince.py
...
class ChangedSince(ChangedSinceBase):
    """Rule that checks for ensembles changed since a specific time."""

    labels      = [ _('Changed after:'), _('but before:') ]
    name        = _('Ensembles changed after <date time>')
    description = _("Matches ensemble records changed after a specified "
