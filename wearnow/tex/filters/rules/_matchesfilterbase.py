...
class MatchesFilterBase(Rule):
    ...
    def prepare(self, db):
        if wearnow.tex.filters.CustomFilters:
            filters = wearnow.tex.filters.CustomFilters.get_filters_dict(self.namespace)
