...
from ..lib import (Textile, Ensemble, MediaObject, Note)
...
class SimpleTable(object):
    ...
    def row(self, *data, **kwargs):
        ...
        for col in range(len(data)):
            ...
            elif isinstance(item, list): # [text, "TextileList", handle, ...]
