...
#
#-------------------------------------------------------------------------
class MediaObject(PrimaryObject):
    """
    ...
    def serialize(self, no_text_date = False):
        ...
        :rtype: tuple
        """
        return (self.handle, self.wearnow_id, self.path, self.mime, self.desc,
                self.checksum,
                self.change,
    ...
    def unserialize(self, data):
        ...
        :type data: tuple
        """
        (self.handle, self.wearnow_id, self.path, self.mime, self.desc,
         self.checksum, self.change, tag_list, self.private) = data
    ...
    def get_text_data_list(self):
        ...
        :rtype: list
        """
        return [self.path, self.mime, self.desc, self.wearnow_id]
