...
class Span(object):
    ...
    """
    BEFORE = 50#config.get('behavior.date-before-range')
    AFTER  = 50#config.get('behavior.date-after-range')
    ABOUT  = 50#config.get('behavior.date-about-range')
    ALIVE  = 110#config.get('behavior.max-age-prob-alive')
