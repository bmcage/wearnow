...
"""
A set of basic utilities that everything in WearNow can depend upon.

The goal is to have this module not depend on any other WearNow module.
That way, e.g. database classes can safely depend on that without
other WearNow baggage.
"""
