...
KEYS = [TEXTILEKEY, ENSEMBLEKEY,  MEDIAKEY, NOTEKEY, TAGKEY]

METHODS = [ADD, UPDATE, DELETE, REBUILD]
METHODS_LIST = [ADD, UPDATE, DELETE]
METHODS_NONE = [REBUILD]

TEXTILECLASS = 'Textile'
ENSEMBLECLASS = 'Ensemble'
#EVENTCLASS = 'Event'
...
CLASS2KEY = {
            TEXTILECLASS: TEXTILEKEY,
            ENSEMBLECLASS: ENSEMBLEKEY,
#            EVENTCLASS: EVENTKEY,
            MEDIACLASS: MEDIAKEY,
            NOTECLASS: NOTEKEY,
            TAGCLASS: TAGKEY
