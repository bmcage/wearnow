...
"""
Exports the DbTxn class for managing WearNow transactions and the undo
database.
"""
...
class DbTxn(defaultdict):
    ...
    def __init__(self, msg, wearnowdb, batch=False, **kwargs):
        """
        Create a new transaction. 
        
        The wearnowdb should have transaction_begin/commit/abort methods, and 
        ...
        The wearnowdb parameter is a reference to the DbWrite object to which
        this transaction will be applied.
        wearnowdb.get_undodb() should return a list-like interface that 
        ...
        self.msg = msg
        self.commitdb = wearnowdb.get_undodb()
        self.db = wearnowdb
        self.batch = batch
...
def testtxn():
    ...
    wearnowdb = FakeDb()
    commitdb = wearnowdb.undodb
    trans = DbTxn("Test Transaction", commitdb, wearnowdb, batch=False)
    wearnowdb.person_map.put('1', "data1")
    trans.add(0, TXNADD, '1', None, "data1")
    wearnowdb.person_map.put('2', "data2")
    trans.add(0, TXNADD, '2', None, "data2")
    wearnowdb.person_map.put('2', "data3")
    trans.add(0, TXNUPD, '2', None, "data3")
    wearnowdb.person_map.delete('1')
