...
"""
Provide the managed window interface, which allows wearnow to track
...
#
#-------------------------------------------------------------------------
from wearnow.tex.const import GLADE_FILE, ICON
...
class WearNowWindowManager(object):
    """
    Manage hierarchy of open WearNow windows.
...
class ManagedWindow(object):
    ...
    management in WearNow: registering the menu item under the Windows
    ...
    def __init__(self, uistate, track, obj):
        ...
        :param uistate:  WearNow uistate
        :param track:    {list of parent windows, [] if the main WearNow window 
                            is the parent}
        :param obj:      The object that is used to id the managed window, 
                            ...
                            for use in the WearNow Window Menu.
        ...
        if uistate and uistate.gwm.get_item_from_id(window_key):
            ...
            # We don't belong to the lop level
                ...
                # On the top level: we use WearNow top window
                if self.uistate:
    ...
    def clean_up(self):
        ...
        If the object is a WearNow widget then it should have a clean_up method
