...
from wearnow.tex.const import ICON, SPLASH, URL_HOMEPAGE
...
class ErrorReportAssistant(Gtk.Assistant):
    """
    Give the user an opportunity to report an error on the wearnow bug
    reporting system.
    """
    ...
    def _start_email_client(self, obj=None):
        ...
        """
        display_url('mailto:benny.malengier@ugent.be?subject='
                          '"bug report"&body="%s"' \
                          % self._final_report_text_buffer.get_text(
                        self._final_report_text_buffer.get_start_iter(),
                        self._final_report_text_buffer.get_end_iter(), True))
        
    def _start_wearnow_bts_in_browser(self, obj=None):
        """
    ...
    def get_intro_text(self):
        ...
        return _("This is the Bug Reporting Assistant. It will "
              "help you to make a bug report to the wearnow "
              ...
              "file a bug report on the wearnow bug tracking system. "
    ...
    def build_page1(self):
        ...
        side_label = Gtk.Label(label=_("This is the detailed wearnow error "
    ...
    def build_page4(self):
        ...
        side_label = Gtk.Label(label=_("This is the completed bug report. "
                                 ...
                                 "to file a bug on the wearnow bug tracking "
                                 "system website."))
    ...
    def build_page5(self):
        ...
        url_label = Gtk.Label(label=_("Use this button to start a web browser "
                                "and file a bug report on the wearnow bug "
                                "tracking system."))
        ...
        url_button.connect('clicked', self._start_wearnow_bts_in_browser)
