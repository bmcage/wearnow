...
manage pages in the main WearNow window.
"""
#-------------------------------------------------------------------------
#
# GNOME modules
...
CATEGORY_ICON = {
    'Garments': 'wearnow-textile',
    'Textile': 'wearnow-textile',
    'WearNow': 'wearnow-comfort',
...
class Navigator(object):
    """
    A class which defines the graphical representation of the WearNow navigator.
    """
    ...
    def view_changed(self, cat_num, view_num):
        """
        Called when a WearNow view is changed.
        """
