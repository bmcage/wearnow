...
from wearnow.tex.merge import MergeNoteQuery
...
class MergeNote(ManagedWindow):
    ...
    def __init__(self, dbstate, uistate, handle1, handle2):
        ...
        wearnow1 = self.no1.get_wearnow_id()
        wearnow2 = self.no2.get_wearnow_id()
        ...
        rbutton_label1.set_label("%s [%s]" % (text1short, wearnow1))
        rbutton_label2.set_label("%s [%s]" % (text2short, wearnow2))
