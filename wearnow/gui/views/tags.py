...
from wearnow.tex.lib import Tag
...
class Tags(DbGUIElement):
    ...
    def _build_tag_menu(self):
        ...
        actions.append(('Tag', 'wearnow-tag', _('Tag'), None, None, None))
        actions.append(('NewTag', 'wearnow-tag-new', _('New Tag...'), None, None,
                        self.cb_new_tag))
        actions.append(('OrganizeTags', None, _('Organize Tags...'), None, None,
                        self.cb_organize_tags))
        actions.append(('TagButton', 'wearnow-tag', _('Tag'), None,
...
class OrganizeTagsDialog(object):
    ...
    def cb_remove_clicked(self, button, top):
        ...
        if prompt:
            ...
            fnc = {'Textile': (self.db.get_textile_from_handle,
                              self.db.commit_textile),
                   'Ensemble': (self.db.get_ensemble_from_handle,
                              self.db.commit_ensemble),
