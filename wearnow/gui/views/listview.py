...
from wearnow.tex.utils.debug import profile
...
class ListView(NavigationView):
    ...
    def goto_handle(self, handle):
        ...
        can end up calling change_active_textile, which can call
        goto_active_textile, causing a bit of recusion. Confusing, huh?

        Unfortunately, row_change has to be able to call change_active_textile,
    ...
    def write_tabbed_file(self, name, type):
        ...
        """
        from wearnow.tex.utils.docgen import CSVTab, ODSTab
        ofile = None
