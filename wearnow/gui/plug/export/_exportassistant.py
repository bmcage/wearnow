...
from wearnow.tex.const import USER_HOME, ICON, SPLASH, WEARNOW_LOCALE as glocale
_ = glocale.translation.gettext
from wearnow.tex.constfunc import conv_to_unicode
from wearnow.tex.config import config
from ...pluginmanager import GuiPluginManager
from wearnow.tex.utils.file import (find_folder, get_new_filename)
...
class ExportAssistant(Gtk.Assistant, ManagedWindow) :
    ...
    def do_prepare(self, page):
        ...
        if back :
            ...
            if success:
                ...
                'now to continue.\n\n'
                'Note: the database currently opened in your ComfiSense '
    ...
    def get_intro_text(self):
        return _('Under normal circumstances, ComfiSense does not require you '
                 ...
                 'in any of the several formats supported by ComfiSense. '
    ...
    def suggest_filename(self):
        ...
        if ext == 'wnow':
            new_filename = os.path.join(default_dir,'data.wnow')
        elif ext == 'burn':
