...
from wearnow.tex.const import THUMBSCALE
...
from wearnow.tex.lib import NoteType
from wearnow.tex.db.txn import DbTxn
from ..glade import Glade
from .displaytabs import (MediaBackRefList, NoteTab)
from ..widgets import (MonitoredSpinButton, MonitoredEntry, PrivacyButton,
                       MonitoredTagList, SelectionWidget, Region)
...
class EditMediaRef(EditReference):
    ...
    def _setup_fields(self):
        ...
        self.gid = MonitoredEntry(
            ...
            self.source.set_wearnow_id,
            self.source.get_wearnow_id,
            self.db.readonly)
...
#            
    ...
    def build_menu_names(self, person):
        ...
        """
        if self.source:
            submenu_label = _('Media: %s')  % self.source.get_wearnow_id()
        else:
