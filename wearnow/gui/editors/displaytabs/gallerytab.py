...
from wearnow.tex.lib import MediaObject, MediaRef
from wearnow.tex.db.txn import DbTxn
from wearnow.tex.utils.file import (media_path_full, media_path, relative_path,
                                   create_checksum)
...
class GalleryTab(ButtonTab, DbGUIElement):
    ...
    def right_click(self, obj, event):
        ...
        if media_path:
            ...
            img = Gtk.Image()
            img.set_from_icon_name("wearnow-viewmedia", Gtk.IconSize.MENU)
            item.set_image(img)
