...
#define APPLICATION_SUBCOM0  0 
#define APPLICATION_SUBCOM1  1
#define APPLICATION_SUBCOM2  2 
#define APPLICATION_SUBCOM3  3 
#define APPLICATION_SUBCOM4  4 
#define APPLICATION_SUBCOM5  5 
#define APPLICATION_SUBCOM6  6
          ...
          if (nfc.tagPresent())
          {
            ...
            //Firmata.sendString(buffer);
                for (int i = 0; i < recordCount; i++)
                {
                    ...
                    //String recType = record.getType(); // will be "" for TNF_EMPTY
...
//        } // end while loop
      ...
      else if ( argv[0] == APPLICATION_SUBCOM1 )
      {
        // unused application command
        Firmata.sendString("APPLICATION Command Warning: This command does not do anything!");
      }
      else if ( argv[0] == APPLICATION_SUBCOM2 )
      {
        // unused application command
        Firmata.sendString("APPLICATION Command Warning: This command does not do anything!");
      }
      else if ( argv[0] == APPLICATION_SUBCOM3 )
      {
        // unused application command
        Firmata.sendString("APPLICATION Command Warning: This command does not do anything!");
      }
      else if ( argv[0] == APPLICATION_SUBCOM4 )
      {
        // unused application command
        Firmata.sendString("APPLICATION Command Warning: This command does not do anything!");
      }
      else if ( argv[0] == APPLICATION_SUBCOM5 )
      {
        // unused application command
        Firmata.sendString("APPLICATION Command Warning: This command does not do anything!");
      }
      else if ( argv[0] == APPLICATION_SUBCOM6 )
      {
        // unused application command
        Firmata.sendString("APPLICATION Command Warning: This command does not do anything!");
      }
      ...
      {
        // did not find this subcommand
        Firmata.sendString("APPLICATION DATA Error: UNKNOWN APPLICATION SUBCOMMAND");
      }
      break ;
  }
}
